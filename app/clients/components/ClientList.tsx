...
export default function ClientList({
  ...
  console.log("🔹 ClientList received clients:", initialClients);
  const [clients, setClients] = useState<ClientList[]>(initialClients);
  const [loading, setLoading] = useState(false);

  // Update local state when props change
  useEffect(() => {
    console.log("🔹 Updating clients state with:", initialClients);
  ...
  const filteredClients = useMemo(() => {
    ...
    console.log("🔹 Filtered and sorted clients:", sorted);
    return sorted;
  }, [clients, searchTerm]);
